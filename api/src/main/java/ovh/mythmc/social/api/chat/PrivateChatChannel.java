...
public class PrivateChatChannel extends ChatChannel {
    ...
    PrivateChatChannel(@NotNull AbstractSocialUser sender, @NotNull AbstractSocialUser recipient) {
        super("PM-" + sender.name() + "-" + recipient.name(), "PM", formattedPmIcon(), hoverText(), NamedTextColor.GREEN, FormatBuilder.empty(), null, false, List.of());
