...
public final class ActionBarMessageHandler extends MessageHandler<MessageHandlerOptions> {

    public static final ActionBarMessageHandler INSTANCE = new ActionBarMessageHandler();

    @Override
    public MessageHandlerResult handle(@NonNull SocialUser recipient, @NonNull SocialHandlerContext context,
        ...
        recipient.sendActionBar(context.message());
