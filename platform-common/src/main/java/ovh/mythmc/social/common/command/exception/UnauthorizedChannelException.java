...
public final class UnauthorizedChannelException extends ParserException {

    private final String input;

    public UnauthorizedChannelException(@NotNull String input, @NotNull ChannelParser parser, @NotNull CommandContext<?> context) {
        super(
            parser.getClass(),
            context,
